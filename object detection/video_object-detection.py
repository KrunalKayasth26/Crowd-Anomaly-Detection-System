...
# # Initialize video
cap = cv2.VideoCapture("G:\Avenue_Dataset\AnomalyEventDetection-master\fight.mp4")
...
model_path = "G:\Avenue_Dataset\AnomalyEventDetection-master\object detection\yolov8\YOLOv8.py"
