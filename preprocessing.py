...
def Fit_Preprocessing(path, frames_ext):
    ...
    for i in tqdm(range(len(onlyfiles))):
        ...
        for img in images:
            ...
            write_path = 'ProcessedImages/'+os.path.basename(path)
...
if __name__=='__main__':    
    ...
    paths = [r'G:\UCSD_Anomaly_Dataset.v1p2\UCSDped1\Test', r'G:\UCSD_Anomaly_Dataset.v1p2\UCSDped2\Test', 
             r'G:\Avenue_Dataset\testing_videos']
    for path in paths:
